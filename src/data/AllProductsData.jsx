...
export const items = [
  ...
  },
  {
    ...
    category: 'chair',
    description:
      'Dining chairs are specifically designed for use with dining tables. They come in a variety of styles, including upholstered chairs, wooden chairs, and modern plastic chairs. Dining chairs are essential for creating a comfortable and inviting dining experience. With their ergonomic designs and supportive features, they allow you to enjoy meals with family and friends in a relaxed and cozy setting.',
    img: Img9,
    title: 'Dining Chair',
    icon: <ShoppingCartRoundedIcon />,
    alt: 'chair',
  ...
  },
  {
    ...
    category: 'chair',
    description:
      'Eames chairs are iconic mid-century modern chairs designed by Charles and Ray Eames. They are known for their sleek and ergonomic designs, combining form and function. Eames chairs come in various styles, such as the Eames Lounge Chair or the Eames Molded Plastic Chair. They are highly sought after for their timeless appeal and are considered design classics in the furniture world.',
    img: Img24,
    title: 'Eames Chair',
    icon: <ShoppingCartRoundedIcon />,
    alt: 'chair',
...

  {
    ...
    category: 'table',
    description:
      'Study tables are designed for studying, reading, or working. They provide a dedicated workspace that allows for better focus and organization. Study tables come in various sizes and designs, from compact desks for small rooms to larger desks with built-in storage options. Having a well-designed study table is essential for creating a productive and comfortable work environment.',
    img: Img27,
    title: 'Study Table',
    icon: <ShoppingCartRoundedIcon />,
    alt: 'table',
  ...
  },
  {
    ...
    category: 'chair',
    description:
      'Papasan chairs are unique and cozy seating options with a round, bowl-shaped seat and a supportive base. They are often made of rattan or other natural materials and come with a soft cushion for added comfort. Papasan chairs offer a relaxing and bohemian vibe, making them a perfect addition to living rooms, reading corners, or outdoor spaces.',
    img: Img29,
    title: 'Papasan Chair',
    icon: <ShoppingCartRoundedIcon />,
    alt: 'chair',
